    ...
    return (
        <div className="max-w-screen-lg mx-auto my-10 p-6 glass rounded-xl text-black dark:text-white drop-shadow-2xl">
            ...
            <form onSubmit={handleUpdateJob} className="card-body">
                <h3 className="font-bold text-lg text-center">Update {job_title}</h3>
                {/* title */}
                ...
                <div className="form-control mt-6">
                    <input className="btn bg-[#5bbb7b] hover:bg-[#43a062] text-black border-0" type="submit" value="Update Job" />
                </div>
            </form>
        </div>
    );
